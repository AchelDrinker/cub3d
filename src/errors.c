...
/*   Updated: 2022/12/22 11:19:57 by humartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ft_murs(recup) == 1)
		ft_error(recup, "Error : Map non entouree de 1\n");
	if (recup->depart == 'x')
		ft_error(recup, "Error : Pas de joueur\n");
	if (recup->indicateur2 != 6)
		ft_error(recup, "Error : Mauvaises donnees F ou C\n");
	if (recup->multijoueurs == 1)
		ft_error(recup, "Error : Plus d'un joueur\n");
	if (recup->lignevide == 1)
		ft_error(recup, "Error : Ligne vide dans la map\n");
	if (recup->wrongcharmap == 2)
		ft_error(recup, "Error : Caractere incorrect dans la map\n");
}
